...
class BeCommerce extends Module
{
	protected $config_form = false;

	public function __construct()
	{
		$this->name = 'becommerce';
		$this->tab = 'others';
		$this->version = '1.0.0';
		...
		$this->displayName = $this->l('BeCommerce');
		$this->description = $this->l('The BeCommerce Quality label provides consumers’ trust and contributes to higher conversion, therefore more turnover.');
